<template>
  ...
  >
    <BaseIcon v-if="loading" size="sm" class="mr-2 animate-spin">
      <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 12a8 8 0 0 1 16 0M4 12a8 8 0 0 0 16 0" />
    </BaseIcon>
...
import { buttonClasses, combineClasses } from '@/styles/component-classes.ts'
