<template>
  <article>
    ...
    <div class="margin-bottom-md">
      <BaseTextArea
        :id="`arabic-${editingSentence?.id || 'editing'}`"
    ...
    <div class="margin-bottom-md">
      <BaseInput
        :id="`transliteration-${editingSentence?.id || 'editing'}`"
    ...
    <div class="margin-bottom-md">
      <BaseInput
        :id="`translation-${editingSentence?.id || 'editing'}`"
    ...
    <div class="margin-bottom-md">
      <BaseTextArea
        :id="`annotations-${editingSentence?.id || 'editing'}`"
